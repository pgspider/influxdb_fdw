...
--
--Testcase 4:
CREATE FOREIGN TABLE inserttest (fields jsonb OPTIONS (fields 'true')) SERVER influxdb_svr OPTIONS (schemaless 'true');
--Testcase 24:
CREATE FOREIGN TABLE inserttest_nsc (col1 int4, col2 int4 NOT NULL, col3 text default 'testing') SERVER influxdb_svr OPTIONS(table 'inserttest');
--Testcase 5:
insert into inserttest_nsc (col1, col2, col3) values (DEFAULT, DEFAULT, DEFAULT);
--Testcase 6:
insert into inserttest_nsc (col2, col3) values (3, DEFAULT);
--Testcase 7:
insert into inserttest_nsc (col1, col2, col3) values (DEFAULT, 5, DEFAULT);
--Testcase 8:
insert into inserttest_nsc values (DEFAULT, 5, 'test');
--Testcase 9:
insert into inserttest_nsc values (DEFAULT, 7);
...
--
--Testcase 11:
insert into inserttest_nsc (col1, col2, col3) values (DEFAULT, DEFAULT);
--Testcase 12:
insert into inserttest_nsc (col1, col2, col3) values (1, 2);
--Testcase 13:
insert into inserttest_nsc (col1) values (1, 2);
--Testcase 14:
insert into inserttest_nsc (col1) values (DEFAULT, DEFAULT);
...
--
--Testcase 16:
insert into inserttest_nsc values(10, 20, '40'), (-1, 2, DEFAULT),
...
--
--Testcase 18:
insert into inserttest_nsc values(30, 50, repeat('x', 10000));

--Testcase 19:
select (fields->>'col1')::int4 col1, (fields->>'col2')::int4 col2, char_length(fields->>'col3') from inserttest;

--Testcase 20:
-- Clean up:
--Testcase 25:
delete from inserttest_nsc;
--Testcase 26:
drop foreign table inserttest;
--Testcase 27:
drop foreign table inserttest_nsc;
/*
-- skip, influxdb does not support create table with WITH option
--
...
/*
-- skip, influxdb does not support create type
--
...
/*
-- skip, influxdb does not support partition table
